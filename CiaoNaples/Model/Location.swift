...
extension Location {
    static let locations = [
        ...
        Location(id: "7", name: "Gran Caffè Gambrinus", coverImage: "gambrinus_cover", images: ["gambrinus1", "gambrinus2", "gambrinus3"], locDescription: "", recommendations: ["Bring cash for your coffee fix", "Enjoy a cozy and relaxed setting", "Sip your brew outdoors"], latitude: 40.8367669, longitude: 14.2484674, category: Category.foodAndDrinks.id, tag: "Drinks", topChoice: true, publicTransport: true, cheapChoice: true),
        
        Location(id: "8", name: "Palazzo Venezia Napoli", coverImage: "palazzovenezia_cover", images: ["palazzovenezia1", "palazzovenezia2", "palazzovenezia3"], locDescription: "", recommendations: ["A great spot for focused study sessions", "Family-friendly drinks for little ones", "A great spot for focused study sessions"], latitude: 40.8479095, longitude: 14.2538121, category: Category.foodAndDrinks.id, tag: "Drinks", topChoice: true, publicTransport: true, cheapChoice: false),
...
//        Location(id: "10", name: "", coverImage: "", images: [""], locDescription: "", recommendations: ["Savor artisanal coffee", "Enjoy a chill atmosphere", "Sip your drink al fresco"], latitude: 40.8479095, longitude: 14.2538121, category: Category.foodAndDrinks.id, tag: "Drinks", topChoice: true, publicTransport: true, cheapChoice: false),
        ...
        // Daily Life
        // Day
        Location(id: "11", name: "Bosco di Capodimone", coverImage: "capodimonte_cover", images: [""], locDescription: "", recommendations: [""], latitude: 40.849751, longitude: 14.263419, category: Category.dailyLife.id, tag: "Day", topChoice: false, publicTransport: true, ticketNeeded: true, cheapChoice: true),
        
        Location(id: "12", name: "Lungomare Caracciolo", coverImage: "lungomare_cover", images: [""], locDescription: "", recommendations: [""], latitude: 40.849751, longitude: 14.263419, category: Category.dailyLife.id, tag: "Day", topChoice: true, publicTransport: false, ticketNeeded: true, cheapChoice: false),
        
        Location(id: "13", name: "Day 3", coverImage: "cover_image", images: [""], locDescription: "", recommendations: [""], latitude: 40.849751, longitude: 14.263419, category: Category.dailyLife.id, tag: "Day", topChoice: false, publicTransport: true, ticketNeeded: false, cheapChoice: false),
        
        Location(id: "14", name: "Day 4", coverImage: "cover_image", images: [""], locDescription: "", recommendations: [""], latitude: 40.849751, longitude: 14.263419, category: Category.dailyLife.id, tag: "Day", topChoice: true, publicTransport: false, ticketNeeded: false, cheapChoice: false),
        
        Location(id: "15", name: "Day 5", coverImage: "cover_image", images: [""], locDescription: "", recommendations: [""], latitude: 40.849751, longitude: 14.263419, category: Category.dailyLife.id, tag: "Day", topChoice: false, publicTransport: false, ticketNeeded: false, cheapChoice: true),
        
        // Night
        Location(id: "16", name: "Anthill", coverImage: "anthill_cover", images: [""], locDescription: "", recommendations: [""], latitude: 40.849751, longitude: 14.263419, category: Category.dailyLife.id, tag: "Night", topChoice: true, publicTransport: true, ticketNeeded: true, cheapChoice: false),
        
        Location(id: "17", name: "Vernissage", coverImage: "vernissage_cover", images: ["vernissage1", "vernissage2", "vernissage3"], locDescription: "A place of meeting and passion for art in all its forms, going from drinks, food and music to the works that you will find exhibited in our spaces", recommendations: ["Sip creative concoctions at mixology bars", "Enjoy live tunes", "Taste unique regional spirits"], latitude: 40.8518422, longitude: 14.2504075, category: Category.dailyLife.id, tag: "Night", topChoice: false, publicTransport: true, ticketNeeded: true, cheapChoice: true),
        
        Location(id: "18", name: "Momah Club", coverImage: "momah_cover", images: [""], locDescription: "", recommendations: [""], latitude: 40.849751, longitude: 14.263419, category: Category.dailyLife.id, tag: "Night", topChoice: false, publicTransport: false, ticketNeeded: true, cheapChoice: true),
        ...
        Location(id: "25", name: "Via Aniello Falcone", coverImage: "aniellofalcone_cover", images: [], locDescription: "", recommendations: ["A peaceful escape from the city buzz", "Convenient parking options", "Engaging for young explorers"], latitude: 40.8401493, longitude: 14.2239159, category: Category.viewpoints.id, topChoice: false, publicTransport: true, ticketNeeded: false, cheapChoice: true),
